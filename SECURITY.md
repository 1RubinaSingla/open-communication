...
- **Deposits** — crediting a transaction that didn't pay the treasury, replaying
  a signature, or claiming someone else's deposit
...
Third-party services we integrate with (Solana RPC providers, Harmonic, search
